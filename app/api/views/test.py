...
from app.api.controllers.posts import get_post_info, get_my_posts, get_post_info_with_slug
...
async def all_posts(
    ...
    posts = get_post_info(db, skip, limit)
    return posts
...
async def my_posts(
    ...
    return get_my_posts(db, current_user["user_id"], skip, limit, post_status)
...
async def get_post(
    ...
    return get_post_info_with_slug(db, slug, skip, limit)
